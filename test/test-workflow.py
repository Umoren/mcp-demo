...
async def test_complete_workflow():
    ...
    try:
        ...
        issue_result = await github_client.call_tool("create_github_issue", {
...
*Auto-generated by MCP workflow at {datetime.now().strftime('%H:%M:%S')}*"""
        ...
        slack_result = await slack_client.call_tool("slack_post_message", {
            "channel_id": "C08V5PY7TEZ",  # Your test channel ID
            "text": slack_message
        })
